...
public class Shotgun extends Pistol {
    ...
    /**
     * Set a direction for all bullets.
     *
     * @param direction of the bullet that shoots straight ahead (String)
     */
    public void setBulletsDirections(String direction) {
        bulletStraight.setDirection(direction);
        bulletLeft.setDirection(setBulletLeftDirection(direction));
        bulletRight.setDirection(setBulletRightDirection(direction));
    }
